    ...
    <div
      ...
      <div style={{ height: "170vh" }}>
        <div className="dot">
          ...
          <section id="section05" ref={scrollBut}></section>
        </div>
      </div>
      <div style={{ height: "250vh" }}>
        <div className="dot">
          ...
          <br />
          <br />I worked hard and got good grades in my IB exams and got into med school at <span>University of Melbourne</span>
          <br />
          <br />
      ...
      <div style={{ height: "200vh" }}>
        <div className="dot">
          ...
          <br />
          <br />
          It did not take me long to make the decision because I did not want to waste the opportunity to see the other side of the world and most importantly, the name sounded
          much less 'bloody'
        </div>
      </div>
      <div style={{ height: "250vh" }}>
        <div className="dot gold">
          ...
          <br />
          <br />
          Most of my London hall mates come from Finance background. Under the influence, I started to be interested in investing. In summer 2019, I got an internship opportunity
          at a private equity firm as an <span>Analyst</span>
        </div>
      </div>
      <div style={{ height: "200vh" }}>
        <div className="dot">
          ...
          <br />
          <br />
          Upon graduation, I wanted to further my study in business side of the story. Combining with my technical Know-How from my undergraduate study, I will be an ideal
          candidate for pharmaceutical investment/consulting companies
          <br />
          <br />I leveraged my undergraduate First Class Honour degree into <span>London School of Economics and Political Science (LSE) & Yale University MBA program</span>
        </div>
      </div>
      <div style={{ height: "100vh" }}>
        <div className="dot ">
          <h1 className="why">BUT WHY</h1>
        </div>
      </div>

      <div style={{ height: "100vh" }}>
        <div className="dot ">
          <h1 className="why">DO ALL OF THESE</h1>
        </div>
      </div>
      <div style={{ height: "100vh" }}>
        <div className="dot ">
          <h1 className="why">HAVE TO DO WITH THE</h1>
        </div>
      </div>
      <div style={{ height: "250vh" }}>
        <div className="dot ">
